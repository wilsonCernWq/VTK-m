                                        ...
                                        vtkm::Range range)
{
  ...
  if (!emptyField1) vtkm::cont::ArrayCopyShallowIfPossible(fields[0].GetData(), floatField1);
  if (!emptyField2) vtkm::cont::ArrayCopyShallowIfPossible(fields[1].GetData(), floatField2);
  if (!emptyField3) vtkm::cont::ArrayCopyShallowIfPossible(fields[2].GetData(), floatField3);
  if (!emptyField4) vtkm::cont::ArrayCopyShallowIfPossible(fields[3].GetData(), floatField4);
